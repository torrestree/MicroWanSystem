...
namespace Client.DomainModels.Managements.Sales
{
    ...
    /// 商机管理器
    /// </summary>
    public class MgtOppty : MgtEFList<CtxRuntime, Oppty>
    {
        /// <summary>
        /// 设置读取实例集合规则
        /// </summary>
        ...
        /// <returns></returns>
        protected override bool SetReadContentsRule(Oppty entity, string value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        protected override bool SetSearchRule(Oppty entity, string value)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        protected override bool SetUnobsoletedRule(Oppty entity)
        {
            return false;
        }
    }
